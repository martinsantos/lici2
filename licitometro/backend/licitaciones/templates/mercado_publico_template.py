...
class MercadoPublicoTemplate(BaseLicitacionTemplate):
    """
    Template para scraping de licitaciones desde Mercado Público
    URL base: https://www.mercadopublico.cl/ (adaptado para Argentina)
    """
    def __init__(self, url: str = 'https://www.argentinacompra.gov.ar/licitaciones'):
        super().__init__(url)
        self.logger = get_logger(self.__class__.__name__)
        
        # URLs específicas para diferentes tipos de licitaciones
        self.licitacion_urls = [
            'https://www.argentinacompra.gov.ar/licitaciones-publicas',
            'https://www.argentinacompra.gov.ar/contrataciones-directas',
            'https://www.argentinacompra.gov.ar/concursos-publicos'
        ]

    def extract_licitaciones(self) -> List[Dict]:
        """
        Extraer licitaciones desde múltiples URLs
        """
